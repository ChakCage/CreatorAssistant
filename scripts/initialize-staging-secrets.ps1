...
$lines = @(
    ...
    "LICENSE_RECOMMENDED_APP_VERSION=0.3.1-beta.5"
    "CREATOR_RELEASE_VERSION=0.3.1-beta.5"
    ...
    "SUPPORT_ADMIN_NOTIFICATION_MODE=dashboard"
    "SUPPORT_FORUM_ENABLED=false"
    "SUPPORT_FORUM_CHAT_ID=0"
    "SUPPORT_FORUM_TOPIC_MODE=per_ticket"
    "SUPPORT_FORUM_DASHBOARD_TOPIC_ENABLED=true"
    "SUPPORT_FORUM_RELAY_ENABLED=true"
