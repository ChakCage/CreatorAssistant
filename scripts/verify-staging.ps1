...
python3 ops/webhook_readiness.py --env-file .env.staging --phase verify --require-empty
...
Write-Host "Staging HTTPS, Telegram webhook readiness, hostname verification, public health, and admin isolation passed."
